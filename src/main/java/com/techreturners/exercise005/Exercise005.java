...
public class Exercise005 {
	...
	// in a packed stadium when successive groups of spectators briefly stand, yell,
	...
	// narrow, the wave can sometimes pass through it. Usually only one wave crest
	// will be present at any given time in an arena, although simultaneous,
